...
public class C02_WebElementLocators {
    public static void main(String[] args) {
        ...
        WebElement ilkUrun = sonuclar.get(0); //Su anda unix hale geldi
        ...
        System.out.println(ilkUrun.isSelected());   //radio button ve checkbox gibi kutucuklu secimlerde kullanilir,
                                                   // bu sebeple secilemez ve false verir
        // ilk urune tıklayın
        ilkUrun.click();
        // sayfayı kapatın
        driver.close();
