...
//testeer olarak asil amacimiz actual ile expected karsilastirilmasidir. actual expected i iceriyor ise passed
// icermiyor ise failed aliriz
...
public class C01_DriverMethods_ClassWork {
    public static void main(String[] args) {
        ...
        //Sayfayi kapatalim
        driver.close();//Browseréi kapatir
